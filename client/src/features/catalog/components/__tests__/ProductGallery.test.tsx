...
describe('ProductGallery lightbox', () => {
  it('shows high-contrast previous and next controls above the image', async () => {
    ...
    expect(previous).toHaveClass('z-20', 'bg-black/70', 'border-white/40');
    expect(next).toHaveClass('z-20', 'bg-black/70', 'border-white/40');
