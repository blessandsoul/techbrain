  ...
  return (
    <footer className="border-t border-border/60 bg-surface mt-auto pb-14 md:pb-0">
      <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-7xl py-12">
        {/* Mobile: single row with phone + socials, no logo */}
        {/* Desktop: two-column grid with logo + socials | contact */}
        <div className="hidden md:grid md:grid-cols-2 gap-8 mb-10">
          {/* Brand */}
          <div>
            <div className="mb-4">
              <Logo className="h-13" />
        ...
        {/* Mobile: phone + social icons in one row */}
