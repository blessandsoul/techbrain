  ...
  return (
    <footer className="border-t border-border/60 bg-surface mt-auto pb-14 md:pb-0">
      <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-7xl py-6">
        {/* Social icons (left) | copyright (center) | phone (right) */}
        <div className="flex flex-wrap items-center justify-between gap-x-4 gap-y-3">
          ...
          <p className="text-sm text-subtle whitespace-nowrap">&copy; {year} {companyName}. {t('footer.rights')}</p>
          ...
          {phone ? (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="ml-auto inline-flex max-w-full shrink-0 items-center gap-2 text-primary hover:text-primary-hover transition-colors duration-200 cursor-pointer group"
            >
