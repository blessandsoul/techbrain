...
export const MobileBottomBar = (): React.ReactElement | null => {
  ...
  if (!phone && !social.facebook) return null;
      ...
      <div className="flex gap-2">
        ...
        {phone && (
          <a
            ...
            aria-label="WhatsApp"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24" className="text-white" aria-hidden="true">
            ...
            <span className="text-sm font-semibold text-white tabular-nums tracking-wide">{formatPhone(phone)}</span>
          </a>
        )}
        ...
        {social.facebook && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex flex-1 items-center justify-center gap-2 h-12 rounded-xl bg-gradient-to-br from-[#1877F2] to-[#0d47a1] shadow-[0_4px_20px_rgba(24,119,242,0.4)] active:scale-[0.97] transition-all duration-200 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1877F2]/50 focus-visible:ring-offset-2"
            aria-label="Facebook"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24" className="text-white" aria-hidden="true">
